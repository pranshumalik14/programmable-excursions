...
$$\mathbf{M}(\mathbf{q})\ddot{\mathbf{q}} + \mathbf{C}(\mathbf{q}, \dot{\mathbf{q}})\dot{\mathbf{q}} + \mathbf{B}(\mathbf{q})\dot{\mathbf{q}} + \nabla_{\mathbf{q}}P(\mathbf{q}) = Y(\mathbf{q}, \dot{\mathbf{q}}, \ddot{\mathbf{q}})\boldsymbol{\Theta}$$
...
l₁ = 0.33; l₂ = 0.275;  # upper and forearm lengths

# ╔═╡ 59d8474f-7514-45a6-85e0-0a5b53a95288
lc₁ = 0.14; lc₂ = 0.11; # upper and forearm centers of mass

# ╔═╡ 5dca8f5b-35b9-45f8-bf77-f7c6a41b327b
I₁ = 1/3m₁*lc₁^2; I₂ = 1/3m₂*lc₂^2; # upper and forearm inertias
...
# ╔═╡ 3150c2ea-873d-440f-b3f0-b28a0a50d9a5
#todo: also add gravity as a parameter here, so that tracking becomes convergent eventually despite perturbation
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "2aaf0798fe745ba2503e2936ef12191bf73ba742"
...
git-tree-sha1 = "5b7ae8b66dfd209acf3da31b3596a3e32070dcd5"
...
git-tree-sha1 = "11c4b28f462714939a604dce67e0176244b652eb"
